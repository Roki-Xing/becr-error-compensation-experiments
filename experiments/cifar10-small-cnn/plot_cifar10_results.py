...
def main() -> None:
    ...
    for mode in order:
        ...
        # scale: show p95 of phi_raw and s (more informative than mean)
    ...
    # (f) Final test acc: aggregate over seeds if multiple seeds exist.
    ...
    fig.suptitle("CIFAR-10 small CNN (mechanism diagnostic, 1200 steps)")
    fig.tight_layout(rect=[0, 0, 1, 0.96])
    fig.savefig(FIG_DIR / "cifar10_coordproj__MAIN.png", dpi=240)
    fig.savefig(FIG_DIR / "cifar10_coordproj__MAIN.pdf")
    plt.close(fig)

    print("Wrote:", str(FIG_DIR / "cifar10_coordproj__MAIN.png"))
    ...
    fig2, axs2 = plt.subplots(1, 3, figsize=(15.8, 6.0))
    ...
    fig2.suptitle("CIFAR-10 per-layer mechanism diagnostics (weights only)")
    fig2.tight_layout(rect=[0, 0, 1, 0.95])
    fig2.savefig(FIG_DIR / "cifar10_coordproj__PER_LAYER.png", dpi=240)
    fig2.savefig(FIG_DIR / "cifar10_coordproj__PER_LAYER.pdf")
    plt.close(fig2)

    print("Wrote:", str(FIG_DIR / "cifar10_coordproj__PER_LAYER.png"))
